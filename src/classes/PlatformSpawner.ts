...
export default class PlatformSpawner extends Phaser.Physics.Arcade.Group {
    ...
    constructor(world: Phaser.Physics.Arcade.World, scene: Phaser.Scene, player: Ball, config: PlatformSpawnerConfig) {
        super(world, scene, {
            classType: Platform,
        ...
        this.world.addCollider(this, player, (_player: Phaser.Types.Physics.Arcade.GameObjectWithBody | Phaser.Tilemaps.Tile, platform: Phaser.Types.Physics.Arcade.GameObjectWithBody | Phaser.Tilemaps.Tile) => {
    ...
    public createDespawnArea(config: PlatformSpawnerConfig): Phaser.GameObjects.Rectangle {
        ...
        return this.scene.add.rectangle(despawnX, despawnY, despawnWidth, this.mainCamera.height, 0x000000, 0)
    }
